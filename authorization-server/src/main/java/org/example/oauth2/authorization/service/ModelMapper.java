...
import org.example.oauth2.authorization.model.OAuth2ClientCredentialsGrantAuthorization;
import org.example.oauth2.authorization.model.OAuth2DeviceCodeGrantAuthorization;
import org.example.oauth2.authorization.model.OAuth2TokenExchangeGrantAuthorization;
...
final class ModelMapper {
	...
	static OidcCodeGrantAuthorization convertOidcAuthorizationCodeGrantAuthorization(
			OAuth2Authorization authorization) {
		OAuth2CodeGrantAuthorization.AuthorizationCode authorizationCode = extractAuthorizationCode(
				authorization);
		OAuth2GrantAuthorization.AccessToken accessToken = extractAccessToken(authorization);
		OAuth2GrantAuthorization.RefreshToken refreshToken = extractRefreshToken(authorization);
		OidcCodeGrantAuthorization.IdToken idToken = extractIdToken(authorization);

		return new OidcCodeGrantAuthorization(authorization.getId(), authorization.getRegisteredClientId(),
	...
	static OAuth2CodeGrantAuthorization convertOAuth2AuthorizationCodeGrantAuthorization(
		...
		return new OAuth2CodeGrantAuthorization(authorization.getId(),
	...
	static OAuth2GrantAuthorization.AccessToken extractAccessToken(OAuth2Authorization authorization) {
	...
	static OAuth2GrantAuthorization.RefreshToken extractRefreshToken(OAuth2Authorization authorization) {
	...
	static OidcCodeGrantAuthorization.IdToken extractIdToken(OAuth2Authorization authorization) {
		OidcCodeGrantAuthorization.IdToken idToken = null;
		if (authorization.getToken(OidcIdToken.class) != null) {
			OAuth2Authorization.Token<OidcIdToken> oidcIdToken = authorization.getToken(OidcIdToken.class);
			idToken = new OidcCodeGrantAuthorization.IdToken(oidcIdToken.getToken().getTokenValue(),
	...
	static void mapOAuth2AuthorizationGrantAuthorization(
			OAuth2GrantAuthorization authorizationGrantAuthorization,
			OAuth2Authorization.Builder builder) {

		if (authorizationGrantAuthorization instanceof OidcCodeGrantAuthorization authorizationGrant) {
			mapOidcAuthorizationCodeGrantAuthorization(authorizationGrant, builder);
		}
		else if (authorizationGrantAuthorization instanceof OAuth2CodeGrantAuthorization authorizationGrant) {
	...
	static void mapAuthorizationCode(OAuth2CodeGrantAuthorization.AuthorizationCode authorizationCode,
			OAuth2Authorization.Builder builder) {
	...
	static void mapAccessToken(OAuth2GrantAuthorization.AccessToken accessToken,
			OAuth2Authorization.Builder builder) {
		if (accessToken == null) {
			return;
		}
	...
	static void mapRefreshToken(OAuth2GrantAuthorization.RefreshToken refreshToken,
			OAuth2Authorization.Builder builder) {
	...
	static void mapIdToken(OidcCodeGrantAuthorization.IdToken idToken,
			OAuth2Authorization.Builder builder) {
		if (idToken == null) {
			return;
		}
